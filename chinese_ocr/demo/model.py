...
from ..train.ctpn.text_detect import text_detect
from ..train.ocr.model import predict as ocr
from ..train.angle.predict import predict as angle_detect  ##文字方向检测
from math import *
import numpy as np
import cv2
