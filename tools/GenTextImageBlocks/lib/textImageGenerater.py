...
import lib.ImageUtils as ImageUtils
from lib.font import FT
#from imgaug import augmenters as iaa

class TextImageGenerater(object):
    ...
    def GenerateImg(self, stdHeight, maxLeftBlank, maxRightBlank, maxTopBlank, maxBottomBlank, font, text, noiseImg = False, noiseMode = "Imgaug"):
        ...
        return resImage, True

    def GenerateImgs(self, textsFile, imgType = "PURE", noiseMode = "Imgaug"): #type: PURE, NOISE
        ...
        for i in range(count):
            ...
            if (not(imgType == "PURE")) and self.hasTemplate:
                resImage, resState =  self.GenerateImg(32,32,32,5,5,font,texts[textId], True, noiseMode)
            else:
                resImage, resState =  self.GenerateImg(32,32,32,5,5,font,texts[textId], False, )
            if resState is True:
